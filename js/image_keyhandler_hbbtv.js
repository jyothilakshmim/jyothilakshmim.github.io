...
case 13:
			switch(menuPosition) {
				...
				case 5:
					...
					break;
				case 6:
					window.location.replace("imagegallery/italy.html");
					break;
				case 7:
					window.location.replace("imagegallery/venice.html");
					break;
				case 8:
					window.location.replace("imagegallery/spain.html");
					break;
				case 9:
					window.location.replace("imagegallery/malta.html");
					break;
				case 10:
					window.location.replace("imagegallery/rome.html");
					break;
				case 11:
					window.location.replace("imagegallery/paris.html");
					break;
			...
			else if(menuPosition>5 && menuPosition<11)
			{
			document.getElementById("menu" + menuPosition).className = "menuimg";
				menuPosition++;
				document.getElementById("menu" + menuPosition).className = "menuimgborder";
			...
			case 37 :
			 ...
			 if(menuPosition<12 && menuPosition>6)
			{
				document.getElementById("menu" + menuPosition).className = "menuimg";
				menuPosition--;
				document.getElementById("menu" + menuPosition).className = "menuimgborder";
