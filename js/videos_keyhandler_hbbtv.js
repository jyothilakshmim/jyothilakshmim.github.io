...
case 13:
			switch(menuPosition) {
				...
				case 5:
					...
					break;
				case 6:
					window.location.replace("video/italyvideos.html");
					break;
				case 7:
					window.location.replace("video/venicevideos.html");
					break;
				case 8:
					window.location.replace("video/spainvideos.html");
					break;
				case 9:
					window.location.replace("video/maltavideos.html");
					break;
